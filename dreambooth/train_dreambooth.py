...
def parse_args(input_args=None):
    ...
    parser.add_argument("--train_text_encoder", default=False, help="Whether to train the text encoder")
    parser.add_argument(
...
def main(args, memory_record, use_subdir, lora_model=None, lora_alpha=1.0, lora_txt_alpha=1.0, custom_model_name=""):
    global with_prior
    text_encoder = None
